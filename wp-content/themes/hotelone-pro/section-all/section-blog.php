...
$blog_title    = get_theme_mod( 'hotelone_news_title', wp_kses_post('Latest <span>News</span>','hotelone') );
$blog_subtitle    = get_theme_mod( 'hotelone_news_subtitle', wp_kses_post('Look at our latest events or blogs','hotelone') );
...
$blogmoretext    = get_theme_mod( 'hotelone_news_more_text', __('More Blogs','hotelone') );
$col = '';
if( $column == 12){
	$col = 1;
}else if( $column == 6){
				...
				<div class="news">
					...
					<div class="news_body">
						...
						<div class="news_details">
							<i class="fa fa-user"></i> <span><?php _e('Posted by:','hotelone'); ?> </span> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php echo get_the_author_link();?></a>
