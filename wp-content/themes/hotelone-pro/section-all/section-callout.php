...
$callout_title    = get_theme_mod( 'hotelone_calltoaction_title', wp_kses_post('Get Quick Enquiry By Submit Your Query','hotelone') );
$callout_subtitle    = get_theme_mod( 'hotelone_calltoaction_subtitle', wp_kses_post('Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.','hotelone') );
$callout_button_text    = get_theme_mod( 'hotelone_calltoaction_btn_text', wp_kses_post('Enquiry Now','hotelone') );
