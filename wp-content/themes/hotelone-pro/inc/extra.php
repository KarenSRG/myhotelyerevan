...
function hotelone_import_files() {
    return array(
        array(
            ...
            'import_file_url'            => 'https://raw.githubusercontent.com/britetechs/hotelone-demo-pro/master/theme-contents.xml',
            'import_widget_file_url'     => 'https://raw.githubusercontent.com/britetechs/hotelone-demo-pro/master/theme-widgets.wie',
            'import_customizer_file_url' => 'https://raw.githubusercontent.com/britetechs/hotelone-demo-pro/master/theme-customizer-settings.dat',
...
function hotelone_new_excerpt_more( $more ) {
	...
	if( is_front_page() && is_home() || is_page_template('template-service.php') ){
		$textagign = 'center';
	}else{
		$textagign = 'center';
	}
    ...
    if($post->post_type == 'event'){
        $textagign = 'center';
        return sprintf(
        ' ... <div class="text-'.esc_attr( $textagign ).'"><a class="hotel-btn hotel-primary hotel-small room-btn" href="%s">%1s</a></div>',
