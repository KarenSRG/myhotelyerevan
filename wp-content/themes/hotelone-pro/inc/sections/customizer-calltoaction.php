		...
		$wp_customize->add_section( 'hotelone_calltoaction_section' ,
			...
			$wp_customize->add_setting( 'hotelone_calltoaction_hide',
				array(
					...
					'default'           => get_theme_mod('hotelone_calltoaction_hide',false),
				)
			);
			...
			$wp_customize->add_setting( 'hotelone_calltoaction_title',
				array(
					...
					'default'           => get_theme_mod('hotelone_calltoaction_title',esc_html__('Hotelone is well design wordpress theme', 'hotelone')),
				)
			);
			...
			$wp_customize->add_setting( 'hotelone_calltoaction_subtitle',
				array(
					'sanitize_callback' => 'wp_kses_post',
					'default'           => get_theme_mod('hotelone_calltoaction_subtitle',esc_html__('Section subtitle', 'hotelone')),
				)
			);
			...
			$wp_customize->add_setting( 'hotelone_calltoaction_btn_text',
				array(
					...
					'default'           => get_theme_mod('hotelone_calltoaction_btn_text',esc_html__('Buy Now', 'hotelone')),
				)
			);
