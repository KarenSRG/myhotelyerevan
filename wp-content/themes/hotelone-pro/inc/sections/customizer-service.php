		...
		$wp_customize->add_section( 'hotelone_service_section' ,
			...
			$wp_customize->add_setting( 'hotelone_services_title',
				array(
					...
					'default'           => get_theme_mod( 'hotelone_services_title', sprintf( wp_kses_post('Our Services','hotelone') ) ),
				)
			);
			...
			$wp_customize->add_setting( 'hotelone_services_subtitle',
				array(
					'sanitize_callback' => 'wp_kses_post',
					'default'           => get_theme_mod('hotelone_services_subtitle',esc_html__('Section subtitle', 'hotelone')),
				)
			);
