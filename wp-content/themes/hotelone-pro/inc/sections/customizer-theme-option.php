...
function hotelone_customizer_theme_option( $wp_customize ){
	...
	$wp_customize->add_panel( 'hotelone_option',
		...
		$wp_customize->add_section( 'header_topbar_section' ,
            ...
            $wp_customize->add_setting( 'hide_dribbble_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_dribbble_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Dribble Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
			...
			$wp_customize->add_setting( 'dribbble_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('dribbble_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'dribbble_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Dribble URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Dribble page link url here.','hotelone')
                )
            );

            $wp_customize->add_setting( 'hide_linkedin_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_linkedin_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Linked In Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
			...
			$wp_customize->add_setting( 'linkedin_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('linkedin_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'linkedin_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Linked In URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Linked In page link url here.','hotelone')
                )
            );

            $wp_customize->add_setting( 'hide_youtube_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_youtube_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Youube Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
			...
			$wp_customize->add_setting( 'youtube_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('youtube_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'youtube_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Youtube URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Youtube page link url here.','hotelone')
                )
            );
            ...
            $wp_customize->add_setting( 'hide_instagram_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_instagram_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Instagram Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
			...
			$wp_customize->add_setting( 'instagram_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('instagram_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'instagram_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Instagram URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Instagram page link url here.','hotelone')
                )
            );

            $wp_customize->add_setting( 'hide_flickr_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_flickr_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Flickr Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
			
			$wp_customize->add_setting( 'flickr_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('flickr_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'flickr_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Flickr URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Flickr page link url here.','hotelone')
                )
            );

            $wp_customize->add_setting( 'hide_spotify_icon',
                array(
                    'sanitize_callback' => 'hotelone_sanitize_checkbox',
                    'default'           => false,
                    'transport'			=> 'postMessage'
            ...
            $wp_customize->add_control( 'hide_spotify_icon',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Hide Spotify Icon', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => '',
                )
            );
            ...
            $wp_customize->add_setting( 'spotify_url',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('spotify_url','#'),
                    'transport'			=> 'postMessage'
                )
            );
            $wp_customize->add_control( 'spotify_url',
                array(
                    'type'        => 'text',
                    'label'       => esc_html__('Spotify URL', 'hotelone'),
                    'section'     => 'header_topbar_section',
                    'description' => esc_html__('Your Spotify page link url here.','hotelone')
                )
            );
			...
			$wp_customize->add_setting( 'phone',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('phone','+33 555 66 777'),
                    'transport'			=> 'postMessage'
                )
            );
			...
			$wp_customize->add_setting( 'email',
                array(
                    'sanitize_callback' => 'sanitize_text_field',
                    'default'           => get_theme_mod('email','info@demo.com'),
                    'transport'			=> 'postMessage'
                )
            );
		...
		$wp_customize->add_section( 'themecolor_section' , array(
			'title'      => __('Primary Color', 'hotelone' ),
			'panel'  => 'hotelone_option',
		) );
			$wp_customize->add_setting( 'theme_color' , array(
			'default'    => get_theme_mod('theme_color','#d8c46c'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
			));
			$wp_customize->add_control(new HotelOne_Theme_Color_Customize_Control($wp_customize,'theme_color',	array(
			'label'   => __('Primary Color:', 'hotelone'),
			'description'      => __('Choose your primary color for your website.', 'hotelone'),
			'section' => 'themecolor_section',
			'type' => 'radio',
			'choices' => array(
			    '#e8846b' => '#e8846b',
				'#e54b4b' => '#e54b4b',
			...
			'default'    =>get_theme_mod('custom_color_enable',false),
			'sanitize_callback' => 'hotelone_sanitize_checkbox',
			));
			$wp_customize->add_control('custom_color_enable' , array(
			'label' => __('Enable Custom Color:','hotelone' ),
			'description' => __('Check this setting to apply custom color on your website.','hotelone' ),
			'section' => 'themecolor_section',
			'type'=>'checkbox',
			) );
			$wp_customize->add_setting( 'custom_color_scheme' , array(
			'default'    => get_theme_mod('custom_color_scheme',''),
			'sanitize_callback' => 'sanitize_text_field',
			));
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize , 'custom_color_scheme' , array(
			'label' => __('Select Primary Custom Color','hotelone'),
			'description'      => __('Select your custom color.', 'hotelone'),
			'section' => 'themecolor_section',
		...
		$wp_customize->add_section( 'hotelone_page' ,
			...
			$wp_customize->add_control( 'hotelone_page_cover_pd_top',
				array(
					...
					'description'       => esc_html__('The page cover padding top in pixel (px).', 'hotelone'),
					'section'     => 'hotelone_page',
				)
			);
			...
			$wp_customize->add_control( 'hotelone_page_cover_pd_bottom',
				array(
					...
					'description'       => esc_html__('The page cover padding bottom in pixel (px).', 'hotelone'),
					'section'     => 'hotelone_page',
				)
			);
		...
		$wp_customize->add_section( 'single_room_section' ,
			array(
				'priority'    => null,
				'title'       => esc_html__( 'Single Room Settings', 'hotelone' ),
				'description' => '',
				'panel'       => 'hotelone_option',
			)
		);

			$wp_customize->add_setting( 'single_room_related_title',
				array(
					'sanitize_callback' => 'wp_kses_post',
					'default'           => get_theme_mod( 'single_room_related_title', sprintf( wp_kses_post('Related Rooms:','hotelone') ) ),
				)
			);
			$wp_customize->add_control( 'single_room_related_title',
				array(
					'label'     => esc_html__('Related Rooms Title', 'hotelone'),
					'section' 		=> 'single_room_section',
					'description'   => '',
				)
			);

		$wp_customize->add_section( 'single_event_section' ,
			array(
				'priority'    => null,
				'title'       => esc_html__( 'Single Event Settings', 'hotelone' ),
				'description' => '',
				'panel'       => 'hotelone_option',
			)
		);

			$wp_customize->add_setting( 'single_event_related_title',
				array(
					'sanitize_callback' => 'wp_kses_post',
					'default'           => get_theme_mod( 'single_event_related_title', sprintf( wp_kses_post('Related Events:','hotelone') ) ),
				)
			);
			$wp_customize->add_control( 'single_event_related_title',
				array(
					'label'     => esc_html__('Related Events Title', 'hotelone'),
