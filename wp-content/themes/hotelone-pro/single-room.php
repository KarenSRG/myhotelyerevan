	...
	<div class="container">
		...
		<div class="col-md-<?php echo esc_attr( $col ); ?> primary">
			...
			if ( have_posts() ) :
				...
				$categories = get_the_terms($post->ID, "room_categories");
					...
					<div class="col-md-4 col-sm-6 wow animated rollIn">
						<div class="card-room">
							...
							<div class="text-center">
								<a class="hotel-btn hotel-primary hotel-small room-btn" href="<?php echo esc_url( $link ); ?>"><?php echo $meta['btntext']; ?> <i class="fa fa-arrow-right"></i></a>
							</div>						
						</div>
					</div>
					<?php endwhile; ?>
